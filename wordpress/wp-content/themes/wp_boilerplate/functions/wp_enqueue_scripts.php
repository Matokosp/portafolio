...
function dl_enqueue_scripts() {
	...
	wp_register_script( 'myscript', get_theme_file_uri('/assets/js/myscript.js'), $deps, $theme_data->get( 'Version' ), true );
	wp_register_script( 'masonry', 'https://unpkg.com/masonry-layout@4/dist/masonry.pkgd.js', true);
	wp_register_script( 'bootstrap', 'https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js', array('jquery'), true);
	wp_register_script( 'scrollSnap', get_theme_file_uri('/assets/js/lib/jquery-scroll-snap.js'), $deps, $theme_data->get( 'Version' ), true );
